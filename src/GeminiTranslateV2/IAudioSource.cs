...
public interface IAudioSource : IDisposable
{
    ...
    /// <summary>Mono PCM16 chunk, exactly as captured — fired for every chunk, unconditionally. No local silence gate: the model segments turns itself from the continuous stream.</summary>
